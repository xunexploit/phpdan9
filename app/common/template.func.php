...
function template_compile($from, $to) {
	...
	if (defined('IN_MODULE') &&
		...
		$extra_code = "<script>var we7CommonForModule = document.createElement(\"script\");we7CommonForModule.src = '//cdn.w7.cc/we7/w7windowside.js?v=201903251513';document.body.appendChild(we7CommonForModule)
</script>";
		$content .= $extra_code;
	}
