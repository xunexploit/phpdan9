                    ...
                    if (empty($item["params"]["goodsdata"])) {
                        foreach ($item["data"] as $childid => $childgoods) {
                            ...
                            foreach ($goods as $index => $good) {
                                if (isset($childgoods) && !empty($childgoods) && $good["id"] == $childgoods["gid"]) {
    ...
    global $_W;
        ...
        public function sendMessage($openid = "", $data = array(), $message_type = "")
        {
            ...
            if ($message_type == TM_CYCELBUY_SELLER_DATE) {
                ...
                $message = array("first" => array("value" => $data["nickname"] . "修改了收货时间", "color" => "#ff0000"), "keyword1" => array("title" => "业务类型", "value" => "会员通知", "color" => "#000000"), "keyword2" => array("title" => "业务内容", "value" => $data["nickname"] . "修改了收货时间", "color" => "#000000"), "keyword3" => array("title" => "处理结果", "value" => "修改收货时间通知", "color" => "#000000"), "keyword4" => array("title" => "操作时间", "value" => date("Y-m-d H:i:s", time()), "color" => "#000000"), "remark" => array("value" => "\n感谢您的支持", "color" => "#000000"));
                ...
                if ($message_type == TM_CYCELBUY_SELLER_ADDRESS) {
                    ...
                    $message = array("first" => array("value" => $data["nickname"] . "修改了收货地址！", "color" => "#ff0000"), "keyword1" => array("title" => "业务类型", "value" => "会员通知", "color" => "#000000"), "keyword2" => array("title" => "业务内容", "value" => $data["nickname"] . "修改了收货地址", "color" => "#000000"), "keyword3" => array("title" => "处理结果", "value" => "修改收货地址通知", "color" => "#000000"), "keyword4" => array("title" => "操作时间", "value" => date("Y-m-d H:i:s", time()), "color" => "#000000"), "remark" => array("value" => "\n感谢您的支持", "color" => "#000000"));
                    $datas[] = array("name" => "昵称", "value" => $data["nickname"]);
                    ...
                    if ($message_type == TM_CYCELBUY_BUYER_DATE) {
                        ...
                        $text = "您已修改了收货时间！\n" . date("Y-m-d H:i") . "\n";
                        $message = array("first" => array("value" => "亲爱的" . $data["nickname"] . "，您修改了收货时间", "color" => "#ff0000"), "keyword1" => array("title" => "业务类型", "value" => "会员通知", "color" => "#000000"), "keyword2" => array("title" => "业务内容", "value" => "您的收货时间已修改", "color" => "#000000"), "keyword3" => array("title" => "处理结果", "value" => "修改收货时间通知", "color" => "#000000"), "keyword4" => array("title" => "操作时间", "value" => date("Y-m-d H:i:s", time()), "color" => "#000000"), "remark" => array("value" => "\n感谢您的支持", "color" => "#000000"));
                        $toopenid = $openid;
                        $datas[] = array("name" => "昵称", "value" => $data["nickname"]);
                        ...
                        if ($message_type == TM_CYCELBUY_BUYER_ADDRESS) {
                            ...
                            $text = "您的收货地址已修改！\n" . date("Y-m-d H:i") . "\n";
                            $message = array("first" => array("value" => "亲爱的" . $member["nickname"] . "，您的收货地址修改完成", "color" => "#ff0000"), "keyword1" => array("title" => "业务类型", "value" => "会员通知", "color" => "#000000"), "keyword2" => array("title" => "业务内容", "value" => "您的收货地址修改已完成", "color" => "#000000"), "keyword3" => array("title" => "处理结果", "value" => "修改收货地址通知", "color" => "#000000"), "keyword4" => array("title" => "操作时间", "value" => date("Y-m-d H:i:s", time()), "color" => "#000000"), "remark" => array("value" => "\n感谢您的支持", "color" => "#000000"));
                            $toopenid = $openid;
