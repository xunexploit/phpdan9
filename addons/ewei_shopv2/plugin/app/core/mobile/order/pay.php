...
class Pay_EweiShopV2Page extends AppMobilePage
{
	...
	protected function creditpay_log($openid = '', $fee = 0, $orderid = 0)
	{
		...
		$log_data = array('uniacid' => $uniacid, 'openid' => $openid,'agentid'=>$order['agentid'], 'type' => 2, 'logno' => $order['ordersn'], 'title' => '小程序商城消费', 'createtime' => TIMESTAMP, 'status' => 1, 'money' => 0 - $fee, 'rechargetype' => 'wxapp', 'remark' => '小程序端余额支付');
