...
class Apply_EweiShopV2Page extends CommissionMobileLoginPage
{
	public function main()
	{
		...
		if ($_W['ispost']) {
			...
			foreach ($log_ids as $o) {
				pdo_update('ewei_shop_member_log', array('status1' => 1, 'applytime' => $time), array('id' => $o, 'uniacid' => $_W['uniacid']));
			}
			...
			$apply['logids'] = iserializer($log_ids);
			$apply['mid'] = $member['id'];
