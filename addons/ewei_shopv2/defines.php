...
define("EWEI_SHOPV2_AUTH_WXAPP","http://wxapp.bdou.cc/");
//!defined('EWEI_SHOPV2_NEW_AUTH_URL') && define('EWEI_SHOPV2_NEW_AUTH_URL', 'https://upgrader-hjeg.we7shop.com/api/newapi');
