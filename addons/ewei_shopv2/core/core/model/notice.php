...
class Notice_EweiShopV2Model
{
    ...
    public function sendMerchSuccess($id)
    {
        ...
        $text = "您好，您提交的资料已通过审核。";
        $msg = array("first" => array("value" => "您好，您提交的资料已通过审核。", "color" => "#000000"), "keyword1" => array("title" => "审核状态", "value" => "审核通过"), "keyword2" => array("title" => "审核时间", "value" => date("Y-m-d H:i:s", time()), "color" => "#000000"), "remark" => array("value" => "快去打理您的商户吧！", "color" => "#000000"));
    ...
    public function sendMerchFail($id)
    {
        ...
        $account = m("common")->getAccount();
        $text = "您好，您提交的资料未通过审核。";
        $msg = array("first" => array("value" => "您好，您提交的资料未通过审核。", "color" => "#000000"), "keyword1" => array("title" => "审核状态", "value" => "未通过审核"), "keyword2" => array("title" => "审核时间", "value" => date("Y-m-d H:i:s", time()), "color" => "#000000"), "keyword3" => array("title" => "失败原因", "value" => $merch["reason"], "color" => "#000000"), "remark" => array("title" => "备注", "value" => $reason, "color" => "#000000"));
            ...
            if (!empty($order["refundid"])) {
                ...
                if ($refund["status"] == 0) {
                    ...
                    if (!empty($is_send)) {
                        ...
                        $msg = array("first" => array("value" => "您有订单于" . date("Y-m-d H:i", $order["paytime"]) . "申请维权！！\n请登录后台查看维权详情。", "color" => "#ff0000"), "keyword2" => array("title" => "处理进度", "value" => $r_type[$refund["rtype"]] . "申请", "color" => "#000000"), "keyword3" => array("title" => "处理内容", "value" => "维权申请通知", "color" => "#4b9528"), "keyword1" => array("title" => "业务类型", "value" => "会员通知", "color" => "#000000"), "remark" => array("value" => $remark2, "color" => "#000000"));
                        if ($order["paytype"] == 3) {
                            $text = "您有一条维权订单信息！！\n请及时处理。\n\n订单号：\n[订单号]\n订单金额：[订单金额]\n---------------------\n购买商品信息：[商品详情]\n备注信息：[备注信息]\n---------------------\n收货人：[购买者姓名]\n收货人电话:[购买者电话]\n收货地址:[收货地址]\n\n请及时处理";
                        } else {
                            $text = "您有一条维权订单信息！！\n请及时处理。\n\n订单号：\n[订单号]\n订单金额：[订单金额]\n支付时间：[支付时间]\n---------------------\n购买商品信息：[商品详情]\n备注信息：[备注信息]\n---------------------\n收货人：[购买者姓名]\n收货人电话:[购买者电话]\n收货地址:[收货地址]\n\n请及时处理";
                    ...
                    if ($refund["status"] == 5) {
                        ...
                        if ($refund["status"] == 3) {
                            if ($refund["rtype"] == 2 || $refund["rtype"] == 1) {
                                ...
                                $msg = array("first" => array("value" => "您好，您的退换货申请已经通过，请您及时发送快递。\n", "color" => "#ff0000"), "keyword2" => array("title" => "处理进度", "value" => "退换货申请", "color" => "#000000"), "keyword3" => array("title" => "处理内容", "value" => "退换货通过", "color" => "#4b9528"), "keyword1" => array("title" => "业务类型", "value" => "会员通知", "color" => "#000000"), "remark" => array("value" => $remark2, "color" => "#000000"));
                            ...
                            if ($refund["status"] == 1) {
                                ...
                                if ($refund["status"] == -1) {
                                    ...
                                    $msg = array("first" => array("value" => "您好，你有一笔" . $r_type[$refund["rtype"]] . "被驳回，您可以与我们取得联系！\n", "color" => "#ff0000"), "keyword2" => array("title" => "处理进度", "value" => "退换货申请", "color" => "#000000"), "keyword3" => array("title" => "处理内容", "value" => "驳回通知", "color" => "#ff0000"), "keyword1" => array("title" => "业务类型", "value" => "会员通知", "color" => "#000000"), "remark" => array("value" => $remark2, "color" => "#000000"));
            ...
            if ($order["status"] == -1) {
                ...
                if ($order["status"] == 0 && $order["paytype"] == 3) {
                    ...
                    if (!empty($is_send)) {
                        ...
                        $text = "您有新的货到付款订单！！\n请及时安排发货。\n\n订单号：\n[订单号]\n订单金额：[订单金额]\n下单时间：[下单时间]\n---------------------\n购买商品信息：[商品详情]\n备注信息：[备注信息]\n---------------------\n收货人：[购买者姓名]\n收货人电话:[购买者电话]\n收货地址:[收货地址]\n\n请及时安排发货";
                        $msgbuy = array("first" => array("value" => "您的货到付款订单于" . date("Y-m-d H:i", $order["createtime"]) . "已成功下单！！", "color" => "#ff0000"), "keyword1" => array("title" => "订单编号", "value" => $order["ordersn"], "color" => "#000000"), "keyword2" => array("title" => "商品名称", "value" => $goods, "color" => "#000000"), "keyword3" => array("title" => "商品数量", "value" => $goodsnum, "color" => "#000000"), "keyword4" => array("title" => "支付金额", "value" => $order["price"], "color" => "#000000"));
                        $textbuy = "您的货到付款订单！！\n已成功下单。\n\n订单号：\n[订单号]\n订单金额：[订单金额]\n下单时间：[下单时间]\n---------------------\n购买商品信息：[商品详情]\n备注信息：[备注信息]\n---------------------\n收货人：[购买者姓名]\n收货人电话:[购买者电话]\n收货地址:[收货地址]\n\n请保持电话畅通";
                    ...
                    foreach ($order_goods as $og) {
                        if (!empty($og["noticeopenid"]) && !empty($og["noticetype"])) {
                            ...
                            if ($og["noticetype"] == "1" || is_array($noticetype) && in_array("1", $noticetype)) {
                                ...
                                $msg = array("first" => array("value" => "您有新的货到付款订单于" . date("Y-m-d H:i", $order["createtime"]) . "已下单！！\n请登录后台查看详情并及时安排发货。\n", "color" => "#ff0000"), "keyword2" => array("title" => "处理进度", "value" => "商品付款通知", "color" => "#000000"), "keyword3" => array("title" => "处理内容", "value" => "已付款", "color" => "#000000"), "keyword1" => array("title" => "业务类型", "value" => "会员通知", "color" => "#000000"), "remark" => array("value" => $remark, "color" => "#000000"));
                            ...
                            if ($order["status"] == 2 || $order["status"] == 1 && !empty($order["sendtype"])) {
                                ...
                                if ($order["status"] == 3) {
                                    ...
                                    if ($pv && !empty($order["virtual"])) {
                                        ...
                                        if (!empty($is_send)) {
                                            $msg = array("first" => array("value" => $first, "color" => "#4b9528"), "keyword2" => array("title" => "处理进度", "value" => "订单收货通知", "color" => "#000000"), "keyword3" => array("title" => "处理内容", "value" => "虚拟物品及卡密自动发货", "color" => "#000000"), "keyword1" => array("title" => "业务类型", "value" => "会员通知", "color" => "#000000"), "remark" => array("title" => "", "value" => $remark, "color" => "#000000"));
                                            $account = m("common")->getAccount();
                                            if (!empty($tm["openid2"])) {
                                        ...
                                        if ($order["isvirtualsend"]) {
                                            ...
                                            if (!empty($is_send)) {
                                                $msg = array("first" => array("value" => $first, "color" => "#4b9528"), "keyword2" => array("title" => "处理进度", "value" => "订单收货通知", "color" => "#000000"), "keyword3" => array("title" => "处理内容", "value" => "商品自动发货", "color" => "#000000"), "keyword1" => array("title" => "业务类型", "value" => "会员通知", "color" => "#000000"), "remark" => array("title" => "", "value" => $remark, "color" => "#000000"));
                                                $account = m("common")->getAccount();
                                                if (!empty($tm["openid2"])) {
                                                    $openids = explode(",", $tm["openid2"]);
                                                    foreach ($openids as $tmopenid) {
                                            ...
                                            if (!empty($is_send)) {
                                                $msg = array("first" => array("value" => $first, "color" => "#4b9528"), "keyword2" => array("title" => "处理进度", "value" => "订单收货通知", "color" => "#000000"), "keyword3" => array("title" => "处理内容", "value" => "商品确认收货", "color" => "#000000"), "keyword1" => array("title" => "业务类型", "value" => "会员通知", "color" => "#000000"), "remark" => array("title" => "", "value" => $remark, "color" => "#000000"));
                                                $account = m("common")->getAccount();
                                                if (!empty($tm["openid2"])) {
                                                    $openids = explode(",", $tm["openid2"]);
                                                    foreach ($openids as $tmopenid) {
    ...
    public function sendMemberUpgradeMessage($openid = "", $oldlevel = NULL, $level = NULL)
    {
        ...
        $message = array("first" => array("value" => "亲爱的" . $member["nickname"] . "，恭喜您成功升级！\n", "color" => "#ff0000"), "keyword2" => array("title" => "处理进度", "value" => "会员升级", "color" => "#000000"), "keyword3" => array("title" => "处理内容", "value" => "您会员等级从 " . $oldlevelname . " 升级为 " . $level["levelname"] . ", 特此通知!", "color" => "#000000"), "keyword1" => array("title" => "业务类型", "value" => "会员通知", "color" => "#000000"), "remark" => array("value" => "\n您即可享有" . $level["levelname"] . "的专属优惠及服务！", "color" => "#000000"));
    ...
    public function sendStockWarnMessage($goodsid, $optionid)
    {
        ...
        if (!empty($is_send)) {
            ...
            $msg = array("first" => array("value" => "您的商品库存已经不足" . $stockwarn . "，请及时补货！\n", "color" => "#ff0000"), "keyword2" => array("title" => "处理进度", "value" => "商品库存不足", "color" => "#000000"), "keyword3" => array("title" => "处理内容", "value" => "请及时补货", "color" => "#4b9528"), "keyword1" => array("title" => "业务类型", "value" => "会员通知", "color" => "#000000"), "remark" => array("value" => "商品名称：" . $goodtitle, "color" => "#000000"));
            if (!empty($tm["openid3"])) {
    ...
    public function sendFriendCouponTemplateMessage($openid, $params, $type)
    {
        ...
        $datas = array(array("name" => "活动名称", "value" => $params["activity_title"]), array("name" => "活动开始时间", "value" => $params["activity_start_time"]), array("name" => "活动结束时间", "value" => $params["activity_end_time"]), array("name" => "瓜分券领取时间", "value" => $params["receiveTime"]), array("name" => "瓜分券名称", "value" => $params["couponName"]));
        switch ($type) {
            case "friendcoupon_launch":
                $defaultTemplate = array("keyword1" => array("value" => "瓜分券活动领取成功！"), "keyword2" => array("value" => "[活动名称]活动领取成功", "color" => "#4b9528"), "keyword3" => array("value" => "您于[瓜分券领取时间]领取[活动名称]活动"));
                break;
            case "friendcoupon_complete":
                $defaultTemplate = array("keyword1" => array("value" => "瓜分券活动完成通知！"), "keyword2" => array("value" => "[活动名称]活动完成", "color" => "#4b9528"), "keyword3" => array("value" => "您于[瓜分券领取时间]领取[瓜分券名称]"));
                break;
            case "friendcoupon_failed":
                $defaultTemplate = array("keyword1" => array("value" => "瓜分券活动失败通知！"), "keyword2" => array("value" => "[活动名称]活动失败", "color" => "#4b9528"), "keyword3" => array("value" => "您于[瓜分券领取时间]领取的[活动名称]未在规定时间内完成"));
                break;
        }
