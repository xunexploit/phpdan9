...
class Recharge_EweiShopV2Page extends MobileLoginPage
{
	...
	public function submit()
	{
		...
		$log = array('uniacid' => $_W['uniacid'], 'logno' => $logno, 'title' => $set['shop']['name'] . '会员充值', 'openid' => $_W['openid'],'agentid'=>$member['agentid'], 'money' => $money, 'type' => 0, 'createtime' => time(), 'status' => 0, 'couponid' => intval($_GPC['couponid']));
