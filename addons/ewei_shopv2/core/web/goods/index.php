	...
	public function main($goodsfrom = 'sale')
	{
		...
		if (!empty($total)) {
            ...
            if ($_GPC["export"] == 1) {
                ...
                m("excel")->export($list, array("title" => "商品列表明细-" . date("Y-m-d-H-i", time()), "columns" => array(array("title" => "商品名称", "field" => "title", "width" => 24), array("title" => "商品价格", "field" => "marketprice", "width" => 12), array("title" => "商品库存", "field" => "total", "width" => 24), array("title" => "销量", "field" => "salesreal", "width" => 12), array("title" => "实际销量", "field" => "sale_cpcount", "width" => 12), array("title" => "属性", "field" => "shuxing", "width" => 64))));
