                    ...
                    if ($searchfield == "address") {
                        ...
                        if ($searchfield == "expresssn") {
                            ...
                            if ($searchfield == "saler") {
                                if (p("merch")) {
                                    $leftsql .= " left join " . tablename("ewei_shop_merch_saler") . " ms on (ms.id = vgl.salerid or ms.id=vol.salerid) and ms.uniacid=o.uniacid and o.ismerch=1";
