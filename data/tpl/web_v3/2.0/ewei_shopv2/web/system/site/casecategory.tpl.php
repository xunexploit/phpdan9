...
<div class="page-header">
    当前位置：<span class="text-primary">案例分类<?php if(cv('system.site.category.edit')) { ?>(拖动可以排序)<?php  } ?></span>
</div>
                ...
                <?php  if(is_array($list)) { foreach($list as $row) { ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="<?php  echo webUrl('system/site/casecategory/delete', array('id' => $row['id']))?>" data-toggle='ajaxRemove' class="btn btn-default btn-sm btn-operation btn-op" data-confirm="确认删除此分类?">
