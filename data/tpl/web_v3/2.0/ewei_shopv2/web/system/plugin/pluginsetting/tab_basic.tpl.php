<?php defined('IN_IA') or exit('Access Denied');?><div class="alert alert-warning">
    注意：统一权限设置会在【<a href="<?php  echo webUrl('system/plugin/perm')?>" target="_blank">公众号权限</a>】开启之后，设置所有公众号的统一应用权限。如需单独设置，请到【<a href="<?php  echo webUrl('system/plugin/perm')?>" target="_blank">公众号权限</a>】单独设置。
</div>
