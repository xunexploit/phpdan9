...
<div class="page-content">
    ...
    <form <?php  if(cv('shop.cityexpress')) { ?>action="" method="post"<?php  } ?> class="form-horizontal form-validate" enctype="multipart/form-data">
        <input type="hidden" name="id" value="<?php  echo $cityexpress['id'];?>" />
        <div class="form-group">
            <label class="col-lg control-label ">状态</label>
            <div class="col-sm-9 col-xs-12">
                <?php  if(cv('shop.cityexpress.edit')) { ?>
        ...
        <div class="form-group dispatch0">
            ...
            <div class="col-sm-9 col-xs-12">
                ...
                <select name='config[city_code]' id="city_code" class="form-control select2">
                    ...
                    <option <?php  if($cityexpress['city_code']=='0851' ) { ?>selected<?php  } ?>  value="0851">贵阳</option>
                </select>
                <?php  } else { ?>
                <div class='form-control-static'>
                    ...
                    <?php  if($cityexpress['city_code']=='0851' ) { ?>贵阳<?php  } ?>
                </div>
                <?php  } ?>
            </div>
        </div>
