...
<div class="page-header">
    <span>当前位置：<span class="text-primary">主商城操作日志 </span></span>
...
<div class="page-toolbar">
                    ...
                    <div class="input-group-select">
                        <select name='logtype'  class='form-control  input-sm select-md select2'   style="width:250px;"  >
                            ...
                            <?php  } } ?>
                                        ...
                                        <input type="text" class=" form-control" name='keyword' value="<?php  echo $_GPC['keyword'];?>" placeholder="可搜索操作员用户名"> <span class="input-group-btn">
    ...
    <div class="form-group">
        <a href="<?php  echo weburl('perm.log.merch')?>" class="btn btn-default navbar-right" style="margin-bottom: 20px; margin-right: 0; width: 160px;">多商户操作日志&nbsp;&gt;&gt;&gt;</a>
    </div>
