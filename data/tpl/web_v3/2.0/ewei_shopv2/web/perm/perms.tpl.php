         ...
         <label class="col-lg control-label">可用权限</label>
                    ...
                    <div class="col-sm-9 col-xs-12">
                        ...
                        <?php  if(is_array($perms['parent'])) { foreach($perms['parent'] as $key => $value) { ?>
                            <div class='panel-heading' style="background:#f8f8f8;display:<?php  if(!in_array($key,$operator_prems) && $_W['role'] == 'operator') { ?>none<?php  } else if(!in_array($key,$accounts_perms) && !empty($permset)) { ?>none<?php  } ?>" >
                                ...
                                <label class='checkbox-inline'>
                                         ...
                                         <input type='checkbox' id="perm_<?php  echo $key;?>" value='<?php  echo $key;?>' class='perm-all perms' data-group='<?php  echo $key;?>'
                            ...
                            <div class='panel-body perm-group'>
                                ...
                                <?php  if($ke != 'text') { ?>
                                     <label class='checkbox-inline'>
                                         <input type='checkbox'  value='<?php  echo $key;?>.<?php  echo $ke;?>' class='perm-item perms'
                                ...
                                <?php  } else { ?>
                                     <label class='checkbox-inline'>
                                         <input type='checkbox'  value='<?php  echo $key;?>' class='perm-all-item perms'
                                                data-group='<?php  echo $key;?>' data-parent='text'
                                                <?php  if(in_array($key,$role_perms) || in_array($key,$user_perms)) { ?> checked<?php  } ?>
                                         <?php  if(in_array($key,$role_perms) && $_W['action']=='perm.user') { ?> disabled<?php  } ?>
                                ...
                                <span>
                                    ...
                                    <?php  if($k != 'text') { ?>
                                         <label class='checkbox-inline' style="display: <?php  if(!in_array($key.".".$ke.".".$k,$operator_prems) && $_W['role'] == 'operator') { ?>none;<?php  } ?>">
                                             <input type='checkbox'  value='<?php  echo $key;?>.<?php  echo $ke;?>.<?php  echo $k;?>' class='perm-item perms'
                                    ...
                                    <?php  } else { ?>
                                         <label class='checkbox-inline' style="display: <?php  if(!in_array($key.".".$ke,$operator_prems) && $_W['role'] == 'operator') { ?>none;<?php  } ?>">
                                             <input type='checkbox'  value='<?php  echo $key;?>.<?php  echo $ke;?>' class='perm-all-item perms'
                                                    data-group='<?php  echo $key;?>' data-parent='<?php  echo $ke;?>' data-son="<?php  echo $k;?>"
                                                    <?php  if(in_array($key.".".$ke,$role_perms) || in_array($key.".".$ke,$user_perms)) { ?> checked<?php  } ?>
                                             <?php  if(in_array($key.".".$ke,$role_perms) && $_W['action']=='perm.user') { ?> disabled<?php  } ?>
                                ...
                                <?php  if($kk != 'text') { ?>
                                         <label class='checkbox-inline'>
                                             <input type='checkbox'  value='<?php  echo $key;?>.<?php  echo $ke;?>.<?php  echo $k;?>.<?php  echo $kk;?>' class='perm-item perms'
                                ...
                                <?php  } else { ?>
                                         <label class='checkbox-inline'>
                                             <input type='checkbox'  value='<?php  echo $key;?>.<?php  echo $ke;?>.<?php  echo $k;?>' class='perm-all-item perms'
                                                    data-group='<?php  echo $key;?>' data-parent='<?php  echo $ke;?>' data-son="<?php  echo $k;?>" data-grandson="<?php  echo $kk;?>"
                                                    <?php  if(in_array($key.".".$ke.".".$k,$role_perms) || in_array($key.".".$ke.".".$k,$user_perms)) { ?> checked<?php  } ?>
                                             <?php  if(in_array($key.".".$ke.".".$k,$role_perms) && $_W['action']=='perm.user') { ?> disabled<?php  } ?>
