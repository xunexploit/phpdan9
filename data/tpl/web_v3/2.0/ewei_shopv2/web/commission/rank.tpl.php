...
<div class='page-header'>
    当前位置：<span class="text-primary">排行榜设置  <?php if(cv('commission.rank')) { ?><?php  } ?></span>
</div>
<div class="page-content">
    <form action="" method="post" class='form-horizontal form-validate'>
        ...
        <div class="form-group">
            <label class="col-lg control-label">排行榜开关</label>
            <div class="col-sm-9 col-xs-12">
        ...
        <div class="form-group">
            <label class="col-lg control-label">排行榜类型</label>
            <div class="col-sm-9 col-xs-12">
                <?php if(cv('commission.rank.edit')) { ?>
                <label class="radio-inline">
        ...
        <div class="form-group">
            <label class="col-lg control-label">排行榜显示数量</label>
            <div class="col-sm-9 col-xs-12">
                <?php if(cv('commission.rank.edit')) { ?>
            ...
            <tr>
                ...
                <td>
                    ...
                    <img onclick="selectImage(this)" onerror="this.src='<?php echo EWEI_SHOPV2_LOCAL;?>static/images/nopic100.jpg'"
                         src="<?php  if(empty($row['avatar'])) { ?><?php echo EWEI_SHOPV2_LOCAL;?>static/images/nopic.png<?php  } else { ?><?php  echo tomedia($row['avatar'])?><?php  } ?>"
                    style="width:40px;height:40px">
                </td>
                <td>
                    <?php if(cv('commission.rank.edit')) { ?>
                    <a href="<?php  echo webUrl('commission.rank.delete', array('id' => $key))?>" data-toggle='ajaxRemove' class="btn btn-default btn-sm btn-op btn-operation" data-confirm="确认删除此虚拟用户?">
