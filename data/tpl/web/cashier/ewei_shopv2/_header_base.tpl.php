...
<html lang="zh-cn">
    <head>
        ...
        <link href="../addons/ewei_shopv2/plugin/cashier/static/css/web.css" rel="stylesheet" type="text/css"/>
    ...
    <body>
    <?php  $userset = $this->getUserSet();?>
    <div class="bg" <?php  if(!empty($userset['bg'])) { ?>style="background-image: url('<?php  echo tomedia($userset['bg'])?>')"<?php  } ?>></div></div>
