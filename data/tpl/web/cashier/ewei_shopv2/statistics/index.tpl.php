...
<form action="./cashier.php" method="get" class="form-horizontal" style="margin-top:20px;">

    <div class="panel panel-default panel-class">
        <div class="panel-heading">
            销售统计 <br/>按年、月、日统计商城交易额、交易量
        </div>

        <div class="panel-body">

            <input type="hidden" name="i" value="<?php  echo $_W['uniacid'];?>"/>
            <input type="hidden" name="r" value="statistics"/>
            <div class="page-toolbar row m-b-sm m-t-sm">
                ...
                <div class="col-sm-12">
                    ...
                    <div class='btn-group btn-group-sm'>
                        ...
                        <button type="submit" name="export" value='1' class="btn btn-sm">导出 Excel</button>
                        <?php  } ?>
                    </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="progress" style='max-width:500px;'>
                            <div style="width: <?php  echo $row['percent'];?>%;" class="progress-bar progress-bar-info"><span
                                    style="color:#000"><?php echo empty($row['percent'])?'':$row['percent'].'%'?></span>
                            </div>
                        </div>
                    </td>
                </tr>
...
<script language='javascript'>
    function get_days() {
        ...
        $.post("<?php  echo cashierUrl('statistics/days')?>", {year: year, month: month}, function (days) {
            day.get(0).options.length = 0;
