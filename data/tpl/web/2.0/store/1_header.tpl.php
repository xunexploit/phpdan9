			...
			<div class="panel-body clearfix main-panel-body ">
				<div class="left-menu">
					<div class="left-menu-content">
						...
						<?php  if(in_array($key, array('store_manage', 'store_payments', 'store_cash_manage')) && !($_W['isfounder'] && !user_is_vice_founder())) { ?>
						<?php  continue;?>
						<?php  } ?>
						<?php  if($key == 'store_cash' && (!user_is_vice_founder() || !$this->store_setting['cash_status'])) { ?>
						<?php  continue;?>
						<?php  } ?>
						<div class="panel panel-menu">
							...
							<ul class="list-group collapse <?php  if($_GPC['menu_fold_tag:'.$key] == 0) { ?>in<?php  } ?>" id="frame-<?php  echo $key;?>">
								...
								<?php  if($menu_key == 'store_goods_users_package' && user_is_vice_founder()) { ?>
									<?php  continue;?>
								<?php  } ?>
								<?php  if($menu_key == 'store_cash_orders' && (!user_is_vice_founder() || !$this->store_setting['cash_status'])) { ?>
									<?php  continue;?>
								<?php  } ?>
        ...
        <div class="skin-2__header">
            ...
            <ul class="user-info">
                ...
                <li class="dropdown user">
                    <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown"><?php  echo $_W['user']['username'];?><span class="caret"></span><i class="wi wi-user"></i></a>
                    <ul class="dropdown-menu color-gray dropdown-menu-right" role="menu">
                        <li>
                            <a href="<?php  echo url('user/profile');?>" target="_blank"><i class="wi wi-money color-gray"></i> 我的账号</a>
                        </li>
