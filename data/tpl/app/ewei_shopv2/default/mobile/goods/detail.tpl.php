...
<div class='fui-swipe goods-swipe' style="height: 0;">
    ...
    <div class='fui-swipe-wrapper'>
        ...
        <div class='fui-swipe-item'>
                <?php  if($index == "0" ) { ?>
                <img src="<?php  echo tomedia($thumb)?>" onload='getHeight(this)' touchstart='getImg(this)'/>
                <?php  } else { ?>
...
<div class="fui-cell-group fui-detail-group" >
    ...
    <div class="fui-cell">
        <div class="fui-cell-text price" >
			...
			<span class="text-danger" style="vertical-align: middle;">
                ...
                <!--最正常价格-->
                &yen;<?php  if($goods['ispresell']>0 && ($goods['preselltimeend'] == 0 || $goods['preselltimeend'] > time()) && $goods['hasoption']==1) { ?>
                        <!--预售-->
                            <?php  echo $goods['minpresellprice'];?>~<?php  echo $goods['maxpresellprice'];?>
                    <?php  } else if($goods['ispresell']>0 && $goods['hasoption']==0) { ?>
    ...
    <!--促销倒计时-->
    <?php  if($goods['isdiscount'] && $goods['isdiscount_time']>=time() && $goods['isdiscount_time_start'] < time()) { ?>
...
<!--配送区域完成-->
<?php  if($has_city && $goods['type']!=5 && $goods['isverify']!=2 ) { ?>
