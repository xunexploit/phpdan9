...
<div class='fui-page  fui-page-current'>
	...
	<div class="fui-cell-group order-info noborder" style="margin-top: 2.2rem">
		<div class="fui-cell" id="btn-address">
			<div class="fui-cell-text">
				<span class="icon icon-weixin1" style="margin-right: .3rem;color:#62b900;font-size:1rem"></span>获取微信收货地址
			</div>
	...
	<?php  } ?>
    <div class='fui-content navbar' <?php  if(is_weixin() && $_W['shopset']['trade']['shareaddress']) { ?>style="top: 4.4rem"<?php  } ?>>
