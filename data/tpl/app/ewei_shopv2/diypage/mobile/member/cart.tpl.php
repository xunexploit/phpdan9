...
<script type="text/html" id="tpl_member_cart_footer">
	<%if list.length>0%>
	<div class="fui-footer cartmode <?php  if(is_h5app()) { ?><%if height == 2436 && width == 1125%>iphonex<%/if%><?php  } ?>  <?php  if(is_weixin()) { ?><%if height == 2436 && width == 1125%>iphonex<%/if%><?php  } ?>" style="bottom: 2.45rem">
