...
$config['db']['master']['username'] = 'chemi_t288_com';
$config['db']['master']['password'] = 'nMxRsnN5Q2eA42ha';
$config['db']['master']['port'] = '3306';
$config['db']['master']['database'] = 'chemi_t288_com';
...
$config['setting']['authkey'] = '4ca18b4f';
