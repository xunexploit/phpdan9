<?php defined('IN_IA') or exit('Access Denied');?><div class="form-group">
	<label class="col-lg control-label">是否开启收银台</label>
	<div class="col-sm-8">
...
<div class="form-group">
	<label class="col-lg control-label">收银台登录地址</label>
...
<div class="form-group">
	<label class="col-lg control-label">登录页面背景</label>
	<div class="col-sm-9 col-xs-12">
		<?php if(cv('cashier.set.edit')) { ?>
		<?php  echo tpl_form_field_image2('data[bg]',$data['bg'],'../addons/ewei_shopv2/plugin/cashier/static/images/bg.jpg')?>
...
<div class="form-group">
	<label class="col-lg control-label must">支付几天后可提现</label>
	<div class="col-sm-8">
		<?php if(cv('cashier.set.edit')) { ?>
		<div class="input-group">
			<input type="text" name="data[payday]" class="form-control" value="<?php  echo $data['payday'];?>"  data-rule-required="true" aria-required="true">
