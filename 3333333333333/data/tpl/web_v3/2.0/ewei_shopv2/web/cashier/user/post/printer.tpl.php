<?php defined('IN_IA') or exit('Access Denied');?><div class="form-group">
	<label class="col-lg control-label">是否打印小票</label>
...
<div class="form-group">
	<label class="col-lg control-label">选择打印机</label>
...
<div class="form-group">
	<label class="col-lg control-label">商品收款模板</label>
	<div class="col-sm-8 col-xs-12">
		<?php if( ce('cashier.user' ,$item) ) { ?>
...
<div class="form-group">
	<label class="col-lg control-label">普通收款模板</label>
	<div class="col-sm-8 col-xs-12">
		<?php if( ce('cashier.user' ,$item) ) { ?>
