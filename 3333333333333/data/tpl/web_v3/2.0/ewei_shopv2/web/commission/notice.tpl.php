        ...
        <div id="advanced">
            ...
            <table class="table table-responsive">
                ...
                <tr>
                    ...
                    <td>
                        <select class="select2"<?php if(cv('commission.notice.edit')) { ?>name="data[apply_commission]"<?php  } else { ?>disabled<?php  } ?>>
                        <option value=''>[默认]申请成为分销商通知</option>
                        <?php  if(is_array($template_list['commission_become_apply'])) { foreach($template_list['commission_become_apply'] as $template_val) { ?>
                        <option value="<?php  echo $template_val['id'];?>" <?php  if($data['tm']['apply_commission'] == $template_val['id'] ) { ?>selected<?php  } ?>><?php  echo $template_val['title'];?></option>
                        <?php  } } ?>
                        </select>
                    </td>
                    <td style="text-align: right;" class="is_advanced">
                        <label class="notice-default">
                            <input type="hidden" name="data[commission_apply_notice]" value="<?php  echo intval($data['tm']['commission_apply_notice'])?>" />
                            <input class="js-switch small checkone" data-type="tpl-advanced"   data-tag="commission_become_apply" type="checkbox" value="<?php  echo intval($data['tm']['commission_apply_notice'])?>" <?php  if(empty($data['tm']['commission_apply_notice'])) { ?>checked<?php  } ?>/>
                        </label>
                ...
                <tr>
                    <td style="vertical-align: top;">选择通知人-<br/>申请成为分销商通知</td>
                    <td colspan="<?php  if(!empty($salers)) { ?>4<?php  } else { ?>2<?php  } ?>" class="colstd">
                        ...
                        <span class='help-block'>申请成为分销商通知后以模板消息的方式商家通知，可以指定多个人，如果不填写则不通知</span>
                    </td>
                </tr>
