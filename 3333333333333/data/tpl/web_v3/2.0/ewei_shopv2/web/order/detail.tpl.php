...
<div class="page-content">
    ...
    "><i class='fa fa-question-circle'></i></a></span>
                            ...
                            <li class="text">
                                ...
                                <?php  if($item['is_peerpay']) { ?>
                                <a class='label label-primary text-primary' style="color: #fff !important;padding-right: 2px;" data-toggle='ajaxModal' href="<?php  echo webUrl('order/op/peerpay',array('id' => $item['id']))?>">代付<i style="font-size: 12px;position: relative;top: -1px;" class="icow icow-you"></i></a>
                                <?php  } ?>
                            </li>
    ...
    "><i class='icow icow-help' style="font-size: 13px;color: #2f3434;margin-left: -3px"></i></a>
                            ...
                            <li class="text">
                                ...
                                <span class="text-default">
					                <?php  if(!empty($row['verifytime'])) { ?>
                                    <?php  echo date('Y-m-d H:i:s', $item['verifytime'])?>
                                    <?php  } else { ?>
                                    -
                                    <?php  } ?>
                                    </span>
            ...
            <div class=" order-container-static">
                <div class=" status">
                    ...
                    <?php  if(!empty($item['canceltime'])) { ?>
                    <span>(关闭时间:<?php  echo date('Y-m-d H:i:s',$item['canceltime'])?>)</span>
                    <?php  } ?>
                    <?php  } ?>
                    <i>
                        <?php  if($item['status'] == 0) { ?>
                ...
                <div>
                    <ul>
                        ...
                        <li class="text">快递单号：<span class="text-default"><?php  echo $item['expresssn'];?></span>&nbsp;<a class="text-primary op" data-toggle="ajaxModal" href="<?php  echo webUrl('util/express', array('id' => $item['id'],'express'=>$item['express'],'expresssn'=>$item['expresssn'],'mobile'=>$user['mobile']))?>">查看物流</a></li>
        ...
        <?php  } ?>
        <?php  if(!empty($fullbackid) && $item['status'] ==3) { ?>
        <h3 class="order-title">全返信息</h3>
        <div class="order-container full-info">
            <div style="padding: 12px;line-height: 26px;width: 100%;">
            <div class="text">
                <span class="col-sm">创建时间:</span> <span class="text-default"><?php  echo date('Y/m/d h:i:s', $alldata['createtime'])?></span>
            </div>
            <div class="flex">
                <div class="text">
                    <span class="col-sm">全返总额:</span> <span class="text-default">&yen;<?php  echo $alldata['allprice'];?></span>
                </div>
                <div class="text">
                    <span class="col-sm">已返金额:</span> <span class="text-default">&yen;<?php  echo $alldata['hasprice'];?></span>
                </div>
            </div>
            <div class="flex">
                <div class="text">
                    <span class="col-sm">返还天数:</span> <span class="text-default"><?php  echo $alldata['day'];?></span>
                </div>
                <div class="text">
                    <span class="col-sm">已返天数:</span> <span class="text-default"><?php  echo $alldata['fullbackday'];?></span>
                </div>
            </div>
        </div>
        </div>
        ...
        overflow: hidden;text-overflow: ellipsis;"><?php  echo $goods['title'];?></a>
                        ...
                        <?php  if(!empty($goods['fullbackid'])) { ?>
                        <div style="float: right;display: inline-block;">

                            <div class="rr-label">全返</div>

                            <?php  if($item['status'] == 3) { ?>
                            <div class="rr-process" id=""><?php  echo tpl_selector_new('goodsid',array(
                                    'required'=>true,
                                'type'=>'fullback',
                                'value'=>$item['title'],
                ...
                <td style="text-align: center">
                    <?php  if($goods['single_refundstate']) { ?>
                        <?php  if($goods['single_refundstate']==8) { ?>
                        <span class="text-danger">已拒绝</span>
                        <?php  } else if($goods['single_refundstate']==9) { ?>
                        <span class="text-danger">维权成功</span>
                        <?php  } else if($goods['single_refundstate']==1) { ?>
                        <span class="text-danger">退款中</span>
                        <?php  } else if($goods['single_refundstate']==2) { ?>
                        <span class="text-danger">退货中</span>
                        <?php  } ?>
                    <?php  } else if($item['refundid'] > 0 && $refund['status'] != -2 && $refund['status'] != -1 ) { ?>
                        <?php  if(!empty($refund) && $refund['status']==1) { ?>
            ...
            <tr class="trorder">
                ...
                <?php $colspan=$item['ispackage']?5:6?>
                <?php  if($showdiyform) { ?>
                    <?php  $colspan++?>
                <?php  } ?>
        ...
        <h3 class="order-title">记次/时核销记录
            ...
            <small>剩余 <?php echo $verifygoods_times_total - $verifygoods_times < 0 ? 0 : $verifygoods_times_total - $verifygoods_times?> / 总数 <span class="text-danger"><?php  echo $verifygoods_times_total;?></span> </small></h3>
        <?php  } ?>
