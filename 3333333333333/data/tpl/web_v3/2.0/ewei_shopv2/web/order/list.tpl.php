            ...
            <div class="input-group">
                ...
                <span class="input-group-select">
                    <select name='searchfield'  class='form-control'   style="width:110px;padding:0 5px;"  >
                        ...
                        <option value='mid' <?php  if($_GPC['searchfield']=='mid') { ?>selected<?php  } ?>>用户id</option>
                        <?php  if($merch_plugin) { ?>
                ...
                <span class="input-group-select">
                    <select name="order_type" class="form-control" style="width:110px;padding:0 5px;">
                        <option value="" <?php  if($_GPC['order_type']=='') { ?>selected<?php  } ?>>全部订单</option>
                        <option value='general' <?php  if($_GPC['order_type']=='general') { ?>selected<?php  } ?>>普通订单</option>
                        <option value='fullback' <?php  if($_GPC['order_type']=='fullback') { ?>selected<?php  } ?>>全返订单</option>
                    </select>
                </span>
                <span class="input-group-btn">
                    ...
                    <div class='table-row table-top' style="padding:0  20px;background: #f7f7f7">
                        <div style="text-align: left;color: #8f8e8e;">
                            <span style="font-weight: bold;margin-right: 10px;color: #2d2d31">
                                ...
                                <?php  if($item['iswxappcreate']==0) { ?><span class="shop">商城</span><?php  } else { ?><span class="min_program">小程序</span><?php  } ?>
                                <?php  if($item['giftSign']==1) { ?><span class="min_program" style=" border:1px solid orange; color: orange;">赠品</span><?php  } ?>
                                <?php  if($item['is_cashier'] == 1) { ?><span class="shop">收银台</span><?php  } ?><?php  echo date('Y-m-d',$item['createtime'])?>&nbsp <?php  echo date('H:i:s',$item['createtime'])?>

                            </span>
                            订单编号:  <?php  echo $item['ordersn'];?><?php  if($item['is_peerpay']) { ?><span class="label label-primary">代付</span><?php  } ?><?php  if($item['ispackage']) { ?>&nbsp;<span class="label label-success">套餐</span><?php  } ?>
                                    ...
                                    <div class="<?php  if($g['single_refundstate']>0) { ?>goodsRefund<?php  } else { ?>noRefund<?php  } ?>">
                                        ...
                                        <?php if(cv('order.op.refund')) { ?>
                                            <?php  if(!empty($g['single_refundid'])) { ?>
                                                <a class='op  text-primary'  href="<?php  echo webUrl('order/op/single_refund', array('id' => $g['ogid']))?>" >维权<?php  if($g['single_refundstate']!=9) { ?>处理<?php  } else { ?>详情<?php  } ?></a>
                                            <?php  } ?>
                                        <?php  } ?>
                            ...
                            <?php  } else { ?>
                                <div class="noRefund">
                                    ...
                                    <?php if(cv('order.op.refund')) { ?>
                                        ...
                                        <a class='op text-primary' style="line-height: 30px;"  href="<?php  echo webUrl('order/op/refund', array('id' => $item['id']))?>" >维权<?php  if($item['refundstate']>0) { ?>处理<?php  } else { ?>详情<?php  } ?></a>
                                        <?php  } ?>
                                    <?php  } ?>
                                    <?php  if($item['addressid']!=0 && $item['statusvalue']>=2 && $item['sendtype']==0 && $item['city_express_state']==0) { ?>
                                        <a class='op  text-primary'  data-toggle="ajaxModal" href="<?php  echo webUrl('util/express', array('id' => $item['id'],'express'=>$item['express'],'expresssn'=>$item['expresssn'],'mobile'=>$item['addressdata']['mobile']))?>">物流信息</a>
