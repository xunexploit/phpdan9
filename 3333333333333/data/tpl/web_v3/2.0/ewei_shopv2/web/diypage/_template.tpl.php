...
<script type="text/html" id="tpl_show_video">
    <div class="drag" data-itemid="<%itemid%>">
        <div class="diy-video style<%style.ratio%>" style='background-image: url("<%imgsrc(params.poster) || "../addons/ewei_shopv2/plugin/diypage/static/images/default/videocover.png"%>")'></div>
    </div>
</script>
        ...
        <div class=" seckill-page">
            <div class="swiper-container room-container">
                <div class="swiper-wrapper" style="height: 40px">
                    <div class="swiper-slide room-slide seckillActive">主会场</div>
                    <div class="swiper-slide room-slide">会场1</div>
                    <div class="swiper-slide room-slide">会场2</div>
                    <div class="swiper-slide room-slide">会场3</div>
                </div>
            </div>
        </div>
    </div>
