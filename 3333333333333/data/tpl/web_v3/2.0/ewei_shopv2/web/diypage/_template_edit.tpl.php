...
<style>
    .pull-right.btn-uploader{float:left!important;width:100%;}
</style>
...
<script type="text/html" id="tpl_edit_video">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            ...
            <%/if%>
            <div class="form-control-static">可上传视频或输入视频地址,不支持提取网络视频</div>
        </div>
    </div>
</script>
...
<script type="text/html" id="tpl_edit_groupsgoods">

    <div class="form-group">
        <div class="col-sm-2 control-label">样式</div>
        <div class="col-sm-10">
            <label class="radio-inline"><input type="radio" name="liststyle" value="block" class="diy-bind" data-bind-child="style" data-bind="liststyle" data-bind-init="true" <%if style.liststyle=='block'%>checked="checked"<%/if%> > 样式一</label>
            <label class="radio-inline"><input type="radio" name="liststyle" value="" class="diy-bind" data-bind-child="style" data-bind="liststyle" data-bind-init="true" <%if style.liststyle==''%>checked="checked"<%/if%>> 样式二</label>
        </div>
    </div>
    ...
    <div class="form-group">
        <div class="col-sm-2 control-label">拼团价格颜色</div>
        <div class="col-sm-4">
            <div class="input-group">
                <input class="form-control input-sm diy-bind color" data-bind-child="style" data-bind="pricecolor" value="<%style.pricecolor%>" type="color" />
                <span class="input-group-addon btn btn-default" onclick="$(this).prev().val('#ff5555').trigger('propertychange')">重置</span>
    ...
    <div class="form-group">
        <div class="col-sm-2 control-label">拼团标签颜色</div>
        <div class="col-sm-4">
            <div class="input-group">
                <input class="form-control input-sm diy-bind color" data-bind-child="style" data-bind="buybtncolor" value="<%style.buybtncolor%>" type="color" />
                <span class="input-group-addon btn btn-default" onclick="$(this).prev().val('#ff5555').trigger('propertychange')">重置</span>
    ...
    <div class="form-group">
        <div class="col-sm-2 control-label">拼团角标颜色</div>
        <div class="col-sm-4">
            <div class="input-group">
                <input class="form-control input-sm diy-bind color" data-bind-child="style" data-bind="groupscorner" value="<%style.groupscorner%>" type="color" />
                <span class="input-group-addon btn btn-default" onclick="$(this).prev().val('#f3f3f3').trigger('propertychange')">重置</span>
            </div>
        </div>
    </div>
