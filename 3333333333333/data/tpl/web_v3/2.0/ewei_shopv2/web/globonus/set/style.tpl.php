...
<div class="form-group">
    ...
    <div class="col-sm-9 col-xs-12">
    	<?php if(cv('globonus.set.edit')) { ?>
			<?php  echo tpl_form_field_image2('data[regbg]',$data['regbg'],'../addons/ewei_shopv2/plugin/globonus/template/mobile/default/static/images/bg.png')?>
		<?php  } else { ?>
			<?php  if(empty($data['regbg'])) { ?>
				<img src="../addons/ewei_shop/plugin/globonus/template/mobile/default/static/images/bg.png" onerror="this.src='../addons/ewei_shop/plugin/globonus/template/mobile/default/static/images/bg.png'; this.title='图片未找到.'" class="img-responsive img-thumbnail" width="150">
			<?php  } else { ?>
				<img src="<?php  echo tomedia($data['regbg'])?>" onerror="this.src='../addons/ewei_shop/plugin/globonus/template/mobile/default/static/images/bg.png'; this.title='图片未找到.'" class="img-responsive img-thumbnail" width="150">
			<?php  } ?>
		<?php  } ?>
    </div>
</div>
<div class="form-group">
	...
	<div class="input-group">
	    <div class="input-group-addon">股东名称</div>
	    <?php if(cv('globonus.set.edit')) { ?>
	    	<input type="text" name="texts[partner]" class="form-control" value="<?php echo empty($data['texts']['partner'])?'股东':$data['texts']['partner']?>"  />
	    <?php  } else { ?>
	    	<div class="form-control valid"><?php echo empty($data['texts']['partner'])?'股东':$data['texts']['partner']?></div>
	    <?php  } ?>
	</div>
    </div>
</div>
<div class="form-group">
    ...
    <div class="col-sm-9 col-xs-12">
	<div class="input-group">
	    <div class="input-group-addon">股东中心</div>
	    <?php if(cv('globonus.set.edit')) { ?>
	    	<input type="text" name="texts[center]" class="form-control" value="<?php echo empty($data['texts']['center'])?'股东中心':$data['texts']['center']?>"  />
	    <?php  } else { ?>
	    	<div class="form-control valid"><?php echo empty($data['texts']['center'])?'股东中心':$data['texts']['center']?></div>
	    <?php  } ?>	
	</div>
    </div>
</div>
<div class="form-group">
    ...
    <div class="col-sm-9 col-xs-12">
	<div class="input-group">
	    <div class="input-group-addon">成为股东</div>
	    <?php if(cv('globonus.set.edit')) { ?>
	    	<input type="text" name="texts[become]" class="form-control" value="<?php echo empty($data['texts']['become'])?'成为股东':$data['texts']['become']?>"  />
	    <?php  } else { ?>
	    	<div class="form-control valid"><?php echo empty($data['texts']['become'])?'成为股东':$data['texts']['become']?></div>
	    <?php  } ?>
	</div>
    </div>
</div>
