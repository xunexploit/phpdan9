...
<div class="page-header">
    当前位置：<span class="text-primary">股东中心入口设置</span>
</div>
<div class="page-content">
    <form id="setform"  <?php if(cv('globonus.cover.edit')) { ?>action="" method="post"<?php  } ?> class="form-horizontal form-validate" >

               <div class="form-group">
                    <label class="col-lg control-label">直接链接</label>
                    <div class="col-sm-9 col-xs-12">
                        <p class='form-control-static'>
                            <a href='javascript:;' class="js-clip" title='点击复制链接' data-url="<?php  echo mobileUrl('globonus',null,true)?>" >
                                <?php  echo mobileUrl('globonus',null,true)?>
                            </a>
