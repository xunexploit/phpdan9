<?php defined('IN_IA') or exit('Access Denied');?> <div class="form-group">
                <label class="col-lg control-label">会员中心股东中心入口</label>
                <div class="col-sm-9 col-xs-12">
                    ...
                    <span class="help-block">会员中心是否显示股东中心入口</span>
                    <?php  } else { ?>
	   ...
	   <div class="form-group">
                <label class="col-lg control-label">分销中心股东中心入口</label>
                <div class="col-sm-9 col-xs-12">
                	<?php if(cv('globonus.set.edit')) { ?>
                    ...
                    <span class="help-block">分销中心是否显示股东中心入口</span>
                    <?php  } else { ?>
 ...
 <div class="col-sm-5">
     <img src="../addons/ewei_shopv2/plugin/globonus/static/images/register_example.jpg" height="100%" width="100%"/>
 </div>
 </div>
