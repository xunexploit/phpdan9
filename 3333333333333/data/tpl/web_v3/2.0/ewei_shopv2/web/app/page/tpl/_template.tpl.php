    ...
    <div class="drag" data-itemid="<%itemid%>">
        ...
        <div class="detail">
            ...
            <div class="name" style="color: <%style.titlecolor%>;">
                这里是商品标题(商品从设定<%if params.goodsdata=='1'%>分类<%/if%><%if params.goodsdata=='2'%>分组<%/if%><%if params.goodsdata=='3'%>新品商品<%/if%><%if params.goodsdata=='4'%>热卖商品<%/if%><%if params.goodsdata=='5'%>推荐商品<%/if%><%if params.goodsdata=='6'%>促销商品<%/if%><%if params.goodsdata=='7'%>包邮商品<%/if%><%if params.goodsdata=='8'%>限时卖商品<%/if%><%if params.goodsdata=='9'%>积分兑换商品<%/if%><%if params.goodsdata=='10'%>积分抽奖商品<%/if%>读取)
            </div>
            <%/if%>
            <%if params.showprice=='1'%>
            <p class="productprice  <%if (params.showproductprice !=1) && (params.showsales !=1)%>noheight<%/if%>">
...
<script type="text/html" id="tpl_show_groupsgoods">
    <div class="drag" data-itemid="<%itemid%>">
        <div class="fui-goods-group <%style.liststyle%>" style="background: <%style.background%>;">
            <%if params.goodsdata=='0'%>
            <%each data as item%>
            <div class="fui-goods-item" data-goodsid="<%item.gid%>">
                <div class="image " style="background-image: url('<%imgsrc item.thumb%>');" data-text="拼团">
                    <div style="position: relative; top: 0; left: 0; z-index: 9;width: 44px; height: 20px;background: <%style.groupscorner%>;text-align: center;color: #fff">拼团</div>
                    <%if params.showicon=='2'%>
                    <div class="goodsicon <%params.iconposition%>"
                    <%if params.iconposition=='left top'%> style="top: <%style.iconpaddingtop%>px; left: <%style.iconpaddingleft%>px; text-align: left;"<%/if%>
                    <%if params.iconposition=='right top'%> style="top: <%style.iconpaddingtop%>px; right: <%style.iconpaddingleft%>px; text-align: right;"<%/if%>
            ...
            <div class="detail">
                ...
                <div class="price">
                    ...
                    <span class="buy" style="border-color: <%style.buybtncolor%>;color:<%style.buybtncolor%> ">2人团</span>
        ...
        <%each data=["c","d"] as item%>
        <div class="fui-goods-item" data-goodsid="<%item.gid%>">
            <div class="image <%if params.showicon=='1'%><%style.iconstyle%><%/if%>" style="background-image: url('../addons/ewei_shopv2/plugin/app/static/images/default/goods-1.jpg');"  data-text="拼团">
                <%if params.showicon=='2'%>
                <div class="goodsicon <%params.iconposition%>"
                <%if params.iconposition=='left top'%> style="top: <%style.iconpaddingtop%>px; left: <%style.iconpaddingleft%>px; text-align: left;"<%/if%>
                <%if params.iconposition=='right top'%> style="top: <%style.iconpaddingtop%>px; right: <%style.iconpaddingleft%>px; text-align: right;"<%/if%>
