...
<div class="page-header">当前位置：<span class="text-primary">排行榜设置</span></div>
...
<form <?php if(cv('member.rank.edit')) { ?>action="" method="post"<?php  } ?> class='form-horizontal form-validate'>
    ...
    <div class="form-group">
        <label class="col-lg control-label">积分排行榜开关</label>
        <div class="col-sm-9 col-xs-12">
    ...
    <div class="form-group">
        <label class="col-lg control-label">积分榜显示数量</label>
        <div class="col-sm-9 col-xs-12">
            <?php if(cv('member.rank.edit')) { ?>
    ...
    <div class="form-group">
        <label class="col-lg control-label">消费排行榜开关</label>
        <div class="col-sm-9 col-xs-12">
            <?php if(cv('member.rank.edit')) { ?>
            <label class="radio-inline">
    ...
    <div class="form-group">
        <label class="col-lg control-label">消费榜显示数量</label>
        <div class="col-sm-9 col-xs-12">
            <?php if(cv('member.rank.edit')) { ?>
