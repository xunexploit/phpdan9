...
<div class="page-header">
    当前位置：<span class="text-primary"><?php  if(!empty($item['id'])) { ?>编辑<?php  } else { ?>添加<?php  } ?>打印机 <small><?php  if(!empty($item['id'])) { ?>修改【<?php  echo $item['title'];?>】<?php  } ?></small></span>
</div>
    ...
    <div class="row">
        <div class="col-sm-9">
            ...
            <div class="form-group">
                <label class="col-lg control-label must" >打印机名称</label>
            ...
            <div class="form-group">
                <label class="col-lg control-label">打印机类型</label>
                <div class="col-sm-9 col-xs-12">
                    <?php if(cv('sysset.printer.printer_add'||'sysset.printer.printer_edit')) { ?>
            ...
            <div class="form-group">
                <label class="col-lg control-label" >打印机编号</label>
                <?php if(cv('sysset.printer.printer_add'||'sysset.printer.printer_edit')) { ?>
            ...
            <div class="form-group">
                <label class="col-lg control-label" >打印机密钥</label>
                <?php if(cv('sysset.printer.printer_add'||'sysset.printer.printer_edit')) { ?>
                <div class="col-sm-9 title" style='padding-right:0' >
            ...
            <div class="form-group">
                <label class="col-lg control-label" >打印联数</label>
                <?php if(cv('sysset.printer.printer_add'||'sysset.printer.printer_edit')) { ?>
                <div class="col-sm-9 title" style='padding-right:0' >
            ...
            <div class="form-group">
                <label class="col-lg control-label" >URL</label>
                <?php if(cv('sysset.printer.printer_add'||'sysset.printer.printer_edit')) { ?>
                <div class="col-sm-9 title" style='padding-right:0' >
...
<div class="form-group">
    <label class="col-lg control-label" >USER</label>
    <?php if(cv('sysset.printer.printer_add'||'sysset.printer.printer_edit')) { ?>
    <div class="col-sm-9 title" style='padding-right:0' >
...
<div class="form-group">
    <label class="col-lg control-label" >UKEY</label>
    <?php if(cv('sysset.printer.printer_add'||'sysset.printer.printer_edit')) { ?>
    <div class="col-sm-9 title" style='padding-right:0' >
...
<div class="form-group">
    <label class="col-lg control-label" >终端号</label>
    <?php if(cv('sysset.printer.printer_add'||'sysset.printer.printer_edit')) { ?>
    <div class="col-sm-9 title" style='padding-right:0' >
...
<div class="form-group">
    <label class="col-lg control-label" >密钥</label>
    <?php if(cv('sysset.printer.printer_add'||'sysset.printer.printer_edit')) { ?>
    <div class="col-sm-9 title" style='padding-right:0' >
...
<div class="form-group">
    <label class="col-lg control-label" >apiKey</label>
    <?php if(cv('sysset.printer.printer_add'||'sysset.printer.printer_edit')) { ?>
    <div class="col-sm-9 title" style='padding-right:0' >
...
<!--易联云AUTH2.0接口打印机-->
<div id="printer_yilianyun_auth2" class="printer" <?php  if($list['type']!='6') { ?>style="display: none"<?php  } ?>>
    <div class="form-group">
        <label class="col-lg control-label" >终端号</label>
        <?php if(cv('sysset.printer.printer_add'||'sysset.printer.printer_edit')) { ?>
        <div class="col-sm-9 title" style='padding-right:0' >
            <input type="text" name="printer_yilianyun_auth2[machine_code]" class="form-control" value="<?php  echo $printer_yilianyun_auth2['machine_code'];?>"/>
            <span class='help-block'>打印机终端号(支持K4,W1,M1,K2S,K3S) , 之前已接入商城并正常使用的无需在此重新设置</span>
        </div>
        <?php  } else { ?>
        <div class="col-sm-3">
            <div class='form-control-static'><?php  echo $printer_yilianyun_auth2['machine_code'];?></div>
        </div>
        <?php  } ?>
    </div>
    <div class="form-group">
        ...
        <?php if(cv('sysset.printer.printer_add'||'sysset.printer.printer_edit')) { ?>
        <div class="col-sm-9 title" style='padding-right:0' >
            <input type="text" name="printer_yilianyun_auth2[msign]" class="form-control" value="<?php  echo $printer_yilianyun_auth2['msign'];?>"/>
            <span class='help-block'>打印机终端密钥</span>
        </div>
        <?php  } else { ?>
        <div class="col-sm-3">
            <div class='form-control-static'><?php  echo $printer_yilianyun_auth2['msign'];?></div>
        </div>
        <?php  } ?>
    </div>
    <div class="form-group">
        <label class="col-lg control-label" >应用ID</label>
        <?php if(cv('sysset.printer.printer_add'||'sysset.printer.printer_edit')) { ?>
        <div class="col-sm-9 title" style='padding-right:0' >
            <input type="text" name="printer_yilianyun_auth2[partner]" class="form-control" value="<?php  echo $printer_yilianyun_auth2['partner'];?>"/>
            <span class='help-block'>应用id（易联云开发者中心应用管理里获取）,须为自有型应用</span>
        </div>
        <?php  } else { ?>
        <div class="col-sm-3">
            <div class='form-control-static'><?php  echo $printer_yilianyun_auth2['partner'];?></div>
        </div>
        <?php  } ?>
    </div>
    <div class="form-group">
        <label class="col-lg control-label" >应用密钥</label>
        <?php if(cv('sysset.printer.printer_add'||'sysset.printer.printer_edit')) { ?>
        <div class="col-sm-9 title" style='padding-right:0' >
            <input type="text" name="printer_yilianyun_auth2[apikey]" class="form-control" value="<?php  echo $printer_yilianyun_auth2['apikey'];?>"/>
            <span class='help-block'>应用密钥</span>
        </div>
        <?php  } else { ?>
        <div class="col-sm-3">
            <div class='form-control-static'><?php  echo $printer_yilianyun_auth2['apikey'];?></div>
        </div>
        <?php  } ?>
    </div>
    ...
    <div class="form-group">
        ...
        <?php if(cv('sysset.printer.printer_add'||'sysset.printer.printer_edit')) { ?>
        <div class="col-sm-9 title" style='padding-right:0' >
            <input type="text" name="printer_yilianyun_auth2[times]" class="form-control" value="<?php  echo $printer_yilianyun_auth2['times'];?>"/>
            <span class='help-block'>同一订单，打印的次数</span>
        </div>
        <?php  } else { ?>
        <div class="col-sm-3">
            <div class='form-control-static'><?php  echo $printer_yilianyun_auth2['times'];?></div>
        </div>
        <?php  } ?>
    </div>
</div>
    ...
    $(function () {
        ...
        $("#type").on('change',function () {
            ...
            switch (this.value){
                ...
                case '6':$("#printer_yilianyun_auth2").show();break;
            }
        });
