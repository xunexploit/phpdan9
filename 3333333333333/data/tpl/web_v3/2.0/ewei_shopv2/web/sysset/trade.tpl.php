...
<div class="page-content">
    <form action="" method="post" class="form-horizontal form-validate" enctype="multipart/form-data" >
        ...
        <div class='form-group-title'>上门自提设置</div>

        <div class="form-group">
            <label class="col-lg control-label">上门自提文案</label>
            <div class="col-sm-9 col-xs-12">
                <?php if(cv('sysset.trade.edit')) { ?>
                <div class="input-group fixsingle-input-group">
                    <input type="text" name="data[pickuptext]" class="form-control" value="<?php  echo $data['pickuptext'];?>" placeholder="不填写默认为上门自提"/>
                </div>
                <span class='help-block'>显示文案，最多可添加5个字</span>
                <?php  } ?>
            </div>
        </div>
...
<div class='form-group-title'>单品退换</div>
<div class='panel-body'>

    <div class="form-group">
        <label class="col-lg control-label">开启单品退换功能</label>
        <div class="col-sm-9 col-xs-12">
            <?php if(cv('sysset.trade.edit')) { ?>
            <label class='radio-inline'><input type='radio' name='data[single_refund]' value='1' <?php  if($data['single_refund']==1) { ?>checked<?php  } ?>/> 开启</label>
            <label class='radio-inline'><input type='radio' name='data[single_refund]' value='0' <?php  if($data['single_refund']==0) { ?>checked<?php  } ?> /> 关闭</label>
            <span class='help-block'>开启后，订单支持单件商品退换，订单优惠金额按比例均摊至每件商品</span>
            <?php  } else { ?>
            <input type="hidden" name="data[single_refund]" value="<?php  echo $data['single_refund'];?>"/>
            <div class='form-control-static'><?php  if($data['single_refund']==1) { ?>开启<?php  } else { ?>关闭<?php  } ?></div>
            <?php  } ?>
        </div>
    </div>
</div>
