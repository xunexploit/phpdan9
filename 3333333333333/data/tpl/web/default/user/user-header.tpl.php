<?php defined('IN_IA') or exit('Access Denied');?><ul class="we7-page-tab">
	...
	<?php  } ?>
		...
		<?php  if(permission_check_account_user('see_user_manage_founder')) { ?>
		<li <?php  if($controller == 'founder') { ?> class="active"<?php  } ?>><a href="<?php  echo url('founder/display')?>">副站长</a></li>
		<?php  } ?>
