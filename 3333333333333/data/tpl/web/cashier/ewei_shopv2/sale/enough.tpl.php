<?php defined('IN_IA') or exit('Access Denied');?>            <div class="form-group">
                ...
                <div class="col-sm-4 col-xs-6">
                    <?php echo tpl_form_field_eweishop_daterange('enoughtime', array('starttime'=>date('Y-m-d H:i', !empty($item['enoughtime']['start'])?$item['enoughtime']['start']:time()),'endtime'=>date('Y-m-d H:i', !empty($item['enoughtime']['end'])?$item['enoughtime']['end']:time())),true);?>
                </div>
            </div>
