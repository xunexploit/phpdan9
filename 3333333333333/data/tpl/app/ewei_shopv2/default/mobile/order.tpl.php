        ...
        <div class='fui-list-group order-item' data-orderid="<%order.id%>" data-verifycode="<%order.verifycode%>">
                ...
                <div class="fui-list goods-list">
                    ...
                    <div class='fui-list-angle'>
                        &yen; <span class='marketprice'><%(g.price/g.total).toFixed(2)%><br/>
                        <span style="color: #999">x<%g.total%></span><br/>
                ...
                <div class='fui-list-group-title'>
                    ...
                    <%else%>
                    <span class='status noremark'>共 <span><%order.goods_num%></span> 个商品 实付: <span class='text-danger'>&yen; <span class="bigprice"><%order.price%></span></span></span>
                    <%/if%>
                </div>
            </a>
