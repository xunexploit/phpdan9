...
<div class='fui-page fui-page-current'>
    ...
    <div class='fui-content navbar'>
        ...
        <div class="fui-cell-group">
            <div class="fui-cell fui-cell-textarea" style="height: auto;">
                <div class="fui-cell-label " style="margin-top:0.5rem">商品名称</div>
                <div class="fui-cell-info">
                    <textarea rows="3" placeholder="请输入商品名称" style="margin-top: 8px" id="title"><?php  echo $item['title'];?></textarea>
                </div>
            </div>
            <div class="fui-cell">
