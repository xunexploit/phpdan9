        ...
        if ($_GPC["export"] == 1) {
            ...
            foreach ($list as &$row) {
                ...
                if (!empty($row["verifyopenid"]) && $row["verifytype"] == 0) {
                    ...
                    $orderid = $row["id"];
                    $ordersn = $row["ordersn"];
                    if (strstr($ordersn, "ME") && !empty($row["verifyinfo"])) {
